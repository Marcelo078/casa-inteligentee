  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        ...
        cta: "gradient-cta text-cta-foreground hover:opacity-90 hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl",
        hero: "bg-accent text-accent-foreground hover:bg-accent/90 hover:scale-[1.05] active:scale-[0.98] shadow-glow font-bold",
        affiliate: "bg-success text-success-foreground hover:bg-success/90 hover:scale-[1.02] active:scale-[0.98] shadow-lg",
      },
      size: {
